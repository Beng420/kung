...
public final class ScreenEvents {
	/**
	 * An event that is called before {@link class_437#method_25423(int, int) a screen is initialized} to its default state.
	...
	/**
	 * An event that is called after {@link class_437#method_25423(int, int) a screen is initialized} to its default state.
	 *
	 ...
	 * @return the event
	 */
	public static Event<AfterBackground> afterBackground(class_437 screen) {
		Objects.requireNonNull(screen, "Screen cannot be null");
	...
	public interface AfterBackground {
		void afterBackground(class_437 screen, class_332 drawContext, int mouseX, int mouseY, float tickDelta);
	}
